...
fix-abci-app-specs:
	export PYTHONPATH=${PYTHONPATH}:${PWD} && autonomy analyse fsm-specs --update --app-class ZKMLAbciApp --package packages/valory/skills/zkml_abci/ || (echo "Failed to check zkml_abci abci consistency" && exit 1)
