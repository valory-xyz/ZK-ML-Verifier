...
"""This package contains round behaviours of ZKMLAbciApp."""

import packages.valory.skills.verifier_abci.rounds as VerifierAbci
...
abci_app_transition_mapping: AbciAppTransitionMapping = {
    RegistrationAbci.FinishedRegistrationRound: VerifierAbci.SynchronizeVerificationsRound,
    TransactionSubmissionAbciApp.FinishedTransactionSubmissionRound: VerifierAbci.PrepareVoteTransactionRound,
    TransactionSubmissionAbciApp.FailedRound: VerifierAbci.PrepareVoteTransactionRound,
    ResetAndPauseAbci.FinishedResetAndPauseRound: VerifierAbci.SynchronizeVerificationsRound,
